# Copilot Instructions for FarRays Center Web

## Project Overview

**FarRays Center** is a multilingual (ES/EN/CA/FR) React + TypeScript dance school website with server-side prerendering (SSR). It uses Vite, TailwindCSS, and React Router for a modern, SEO-optimized experience targeting Dancehall, Afrobeats, and other urban dance classes in Barcelona.
