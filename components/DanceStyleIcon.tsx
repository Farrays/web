...
const DanceStyleIcon: React.FC<DanceStyleIconProps> = ({ iconId }) => {
      ...
      case 'salsa':
        return (
          <div className="relative w-32 h-32 animate-salsa-spin group-hover:[animation-duration:4s]">
            <div
              className="absolute w-20 h-32 border-2 border-primary-accent rounded-full top-0 left-1/2 -translate-x-1/2 opacity-80 transform-gpu"
              style={{ transform: 'rotate(30deg)' }}
            ></div>
            <div
              className="absolute w-20 h-32 border-2 border-neutral rounded-full top-0 left-1/2 -translate-x-1/2 opacity-60 transform-gpu"
              style={{ transform: 'rotate(-30deg)' }}
            ></div>
          </div>
        );
      case 'bachata':
        return (
          <div className="relative w-24 h-32 animate-bachata-wave group-hover:[animation-duration:2.5s]">
            <div
              className="absolute w-12 h-full bg-gradient-to-b from-primary-accent to-transparent rounded-full top-0 left-4 opacity-90 transform-gpu"
              style={{ animation: 'bachata-wave 5s ease-in-out infinite reverse' }}
            ></div>
      ...
      case 'afrohouse':
        return (
          <div className="relative w-24 h-24">
            ...
            <div
              className="absolute inset-3 border-2 border-neutral rounded-full animate-afro-pulse"
      ...
      case 'flamenco':
        return (
          <div className="relative w-32 h-16 animate-flamenco-fan group-hover:[animation-duration:2.5s] origin-bottom-left">
            <div
              className="absolute w-full h-32 bg-gradient-to-r from-primary-dark via-primary-accent to-primary-dark rounded-tr-full origin-bottom-left"
  ...
  return (
    <div className="absolute transition-opacity duration-500 opacity-30 group-hover:opacity-100">
      {renderIcon()}
    </div>
  );
};
