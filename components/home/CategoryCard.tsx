        ...
        <div className="relative flex flex-col justify-end h-full p-6 text-left">
          ...
          <div className="h-0 group-hover:h-28 overflow-hidden transition-all duration-300 ease-in-out">
            ...
            <button
              ...
              className="mt-3 w-full bg-primary-accent text-white font-bold py-3 px-6 rounded-full transition-all duration-300 hover:bg-white hover:text-primary-accent shadow-lg hover:shadow-accent-glow text-sm opacity-0 group-hover:opacity-100 delay-150"
