...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 py-4 md:py-6 flex items-center relative">
          {/* Left Navigation */}
          ...
          {/* Centered Logo */}
          <Link to={`/${locale}`} aria-label="FIDC Home" className="absolute left-1/2 -translate-x-1/2 z-10 pointer-events-auto">
            <picture>
              ...
              <img
                ...
                width="128"
                height="128"
                className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 transition-transform duration-300 hover:scale-105"
              />
            </picture>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-6 flex-1 justify-end">
            ...
            <Link
              ...
              className="bg-primary-accent text-white font-bold text-lg py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-accent-glow animate-glow"
            >
              {t('enrollNow')}
            </Link>
          </div>
