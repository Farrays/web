...
Los pasos tienen nombres con significado: "Log On" (conectarse), "Willie Bounce" (homenaje a Willie Haggart), "Nuh Linga" (no te demores). Cada movimiento cuenta una historia.`,
  ...
  dhV3Transform1Desc: 'Rompes la rutina, liberas estrés y vuelves a disfrutar.',
  dhV3Transform2Title: 'Ganas Seguridad y Autoestima',
  dhV3Transform2Desc: 'Descubres una versión más auténtica y poderosa de ti.',
  dhV3Transform3Title: 'Te Mantienes en Forma sin Aburrirte',
  dhV3Transform3Desc: 'Cada clase es distinta, dinámica y divertida.',
  dhV3Transform4Title: 'Socializas y Creas Comunidad',
