...
Los pasos tienen nombres con significado: "Log On" (conectarse), "Willie Bounce" (homenaje a Willie Haggart), "Nuh Linga" (no te demores). Cada movimiento cuenta una historia.`,
  ...
  dhV3WhyChoose2Desc: 'Expertas en Dancehall Female, Twerk y cultura afrocaribeña.',
  dhV3WhyChoose3Title: 'Ubicación inmejorable',
  dhV3WhyChoose3Desc: 'Calle Entença 100, entre Plaza España y Sants.',
  dhV3WhyChoose4Title: 'Ambiente familiar e inclusivo',
  dhV3WhyChoose4Desc: 'Sin juicios ni comparaciones. Solo actitud y buena vibra.',
  dhV3WhyChoose5Title: 'Instalaciones preparadas',
  dhV3WhyChoose5Desc: 'Espacios amplios, cómodos y totalmente equipados.',
  dhV3WhyChoose6Title: 'Academia multidisciplinar',
  dhV3WhyChoose6Desc: 'Más de 25 estilos de baile diferentes. El aburrimiento no es opción.',
  dhV3WhyChoose7Title: 'Gala anual y workshops',
  dhV3WhyChoose7Desc: 'Brilla en el Teatro Victòria y participa en eventos durante todo el año.',
