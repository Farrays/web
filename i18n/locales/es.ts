export const es = {
  ...
  happinessStoryPara1Part1: 'No sabíamos que era imposible levantarla en un local abandonado durante 10 años. Tampoco sabíamos que era mala idea reformarlo a mano, sin presupuesto, solo con Yunaisy, Fábio, amigos, profesores y una brigada improvisada. No sabíamos nada de "lo imposible". Así que simplemente lo hicimos. Porque Farray\'s no nació de un plan de negocio.',
  happinessStoryPara1Part2: 'Nació de una historia de amor.',
  happinessStoryPara2: 'Del amor entre Yunaisy y Fábio, del amor por la danza y del amor por la gente. Por eso, cuando decimos que aquí se respira familia, no es un eslogan: es verdad.',
  ...
  happinessStoryPara3Part7: ' —bailarina, maestra internacional y alma de esta casa—, donde cada alumno importa, cada historia cuenta y cada momento te acerca a una versión mejor de ti.',
  happinessStoryPara4: 'Un lugar que no copiamos de ningún sitio. Un lugar que no existía… hasta que lo construimos.',
  // About
  ...
  // FAQ Section
  faqTitle: 'Preguntas Frecuentes Sobre Nuestra Academia de Baile',
  // Home FAQ
  ...
  homeFaqQ3: '¿Cómo es el ambiente en la academia?',
  homeFaqA3:
    'Cuando decimos que aquí se respira familia, no es un eslogan: es verdad. Desde el día uno te sientes acogido. Nuestros alumnos vienen de todos los niveles y edades, y el ambiente es inclusivo, motivador y lleno de energía positiva. Muchos vienen por el baile y se quedan por la comunidad. Hacemos eventos, actuaciones y hasta salidas juntos. Es tu tribu de danza.',
  homeFaqQ4: '¿Qué estilos de baile se pueden aprender en Farray\'s?',
  homeFaqA4:
...
Los pasos tienen nombres con significado: "Log On" (conectarse), "Willie Bounce" (homenaje a Willie Haggart), "Nuh Linga" (no te demores). Cada movimiento cuenta una historia.`,
  ...
  dhV3MetaDescription: 'Aprende Dancehall jamaicano auténtico en Barcelona. Clases desde iniciación hasta avanzado. Profesoras expertas. Entre Plaza España y Sants. ¡Prueba gratis!',
  ...
  dhV3HeroLocation: 'Viaja a Jamaica sin salir de Barcelona | Clases desde iniciación hasta avanzado, entre Plaza España y Sants',
  ...
  dhV3Transform1Desc: 'Las clases te sacan de la rutina y te devuelven la vida.',
  dhV3Transform2Title: 'Ganas seguridad sin darte cuenta',
  dhV3Transform2Desc: 'Te sueltas, te liberas y empiezas a gustarte más.',
  dhV3Transform3Title: 'Te pones en forma sin aburrirte',
  dhV3Transform3Desc: 'Cada clase es distinta. Te ríes, sudas y disfrutas.',
  dhV3Transform4Title: 'Conoces gente real',
  dhV3Transform4Desc: 'Nada forzado: buen rollo, comunidad y gente como tú.',
  dhV3Transform5Title: 'Viajas a Jamaica sin salir de Barcelona',
  dhV3Transform5Desc: 'Ritmo, energía y esencia real en cada clase.',
  ...
  dhV3WhyChooseSubtitle: 'En Barcelona existen muchas escuelas de Dancehall, pero pocas con verdadera trayectoria. En Farray\'s International Dance Center llevamos más de 8 años enseñando Dancehall auténtico.',
  dhV3WhyChoose1Title: 'Academia reconocida por el CID UNESCO',
  dhV3WhyChoose1Desc: 'Dirigida por Yunaisy Farray, actriz de Street Dance 2 y una de las maestras más reconocidas del mundo.',
  dhV3WhyChoose2Title: 'Profesoras formadas en raíces jamaicanas',
  dhV3WhyChoose2Desc: 'Expertas en Dancehall Female, Twerk y cultura afrocaribeña. Clases con flow, técnica y autenticidad.',
  dhV3WhyChoose3Title: 'Ubicación inmejorable',
  dhV3WhyChoose3Desc: 'Calle Entença 100, entre Plaza España y Sants, a 5 minutos de Plaça Espanya y Sants. Metro, buses y tren a la puerta. Fácil llegar. Fácil volver.',
  dhV3WhyChoose4Title: 'Ambiente familiar, con la profesionalidad que necesitas',
  dhV3WhyChoose4Desc: 'Cercano, inclusivo y sin juicios ni comparaciones, pero con la profesionalidad que necesitas para evolucionar de verdad.',
  dhV3WhyChoose5Title: 'Instalaciones preparadas de verdad',
  dhV3WhyChoose5Desc: 'Más de 700 m², salas amplias, espejos, sonido profesional, aire acondicionado y ventilación centralizada para entrenar a gusto todo el año.',
  dhV3WhyChoose6Title: 'Academia multidisciplinar',
  dhV3WhyChoose6Desc: 'Más de 25 estilos para que nunca te aburras y puedas crecer a tu ritmo: urbanos, bailes latinos, contemporáneo, técnica, estiramiento y mucho más.',
  dhV3WhyChoose7Title: 'Gala anual + workshops potentes',
  dhV3WhyChoose7Desc: 'Brilla en un teatro profesional, participa en workshops internacionales y vive experiencias que no encontrarás en ninguna otra escuela.',
  ...
  dhV3Teacher2Specialty: '+6 años como referente en Dancehall & Twerk',
  dhV3Teacher2Bio: 'Carisma, fuerza y flow caribeño en cada clase.',
  dhV3TeachersClosing: 'En Farray\'s Center cada profe enseña con alma, conocimiento y respeto por la cultura.',
  ...
  dhV3FaqTitle: 'Preguntas frecuentes sobre nuestra escuela de Dancehall en Barcelona',
  dhV3FaqQ1: '¿Cómo funcionan nuestras clases de Dancehall en Barcelona?',
  dhV3FaqA1: 'En nuestras clases de Dancehall en Barcelona generalmente se enseña una secuencia coreografiada, pero en la práctica el Dancehall es una danza improvisada. Cada sesión dura 1 hora e incluye: Calentamiento (preparación del cuerpo con ejercicios específicos), Coreografía (secuencias dinámicas que combinan pasos tradicionales y modernos) e Improvisación (trabajo de creatividad para llevar tu baile a un nivel informal, expresivo y con personalidad).',
  dhV3FaqQ2: '¿Puedo empezar desde cero si nunca he bailado Dancehall?',
  dhV3FaqA2: 'Claro. Los alumnos que nunca han bailado antes eligen los cursos de nivel principiante y quienes tienen algo de experiencia en algún tipo de baile eligen el nivel básico. Nuestras clases están diseñadas para que cualquiera pueda seguir el ritmo desde el primer día.',
  dhV3FaqQ3: '¿Qué pasa si no tengo buena coordinación?',
  dhV3FaqA3: 'No te preocupes, la coordinación se desarrolla con la práctica. Nuestros profesores te guiarán paso a paso y el ambiente es muy acogedor. Lo importante es ser constante y disfrutar del proceso.',
  dhV3FaqQ4: '¿Qué necesito traer para las clases de Dancehall en Barcelona?',
  dhV3FaqA4: 'Ropa cómoda y ligera que permita moverte con libertad, zapatillas limpias de uso exclusivo dentro del estudio, toalla y agua, porque bailarás intensamente y necesitas hidratarte.',
  dhV3FaqQ5: '¿Qué estilos de Dancehall enseñamos en nuestra escuela de Barcelona?',
  dhV3FaqA5: 'Dancehall Female: Estilo tradicional jamaicano con movimientos auténticos. Sensualidad, actitud y flow. Dancehall Twerk: Integra movimientos de Twerk/Bootydance. Energía, sensualidad y feminidad.',
  dhV3FaqQ6: '¿Qué niveles de Dancehall tenemos en nuestra escuela de Barcelona?',
  dhV3FaqA6: 'Principiantes: Para empezar desde cero, aprender paso a paso y con buen ambiente. Básico: Para quienes ya tienen algo de experiencia en Dancehall u otras danzas urbanas. Intermedio: Para mejorar técnica, coordinación y musicalidad con pasos más complejos. Avanzado: Para llevar tu nivel al máximo y consolidar tu estilo.',
  dhV3FaqQ7: '¿Puedo unirme en cualquier momento del año?',
  dhV3FaqA7: 'Sí. Puedes empezar cuando quieras. Consulta nuestro calendario para ver las próximas clases disponibles. Si tienes dudas sobre el nivel o el grupo, escríbenos y te orientamos.',
  ...
  dhV3FaqA13: 'Nuestras clases están abiertas a todas las personas, sin importar el género o la experiencia previa. El Dancehall es para todos.',
  dhV3FaqQ14: '¿Qué diferencia el Dancehall de otros estilos de baile urbano?',
  dhV3FaqA14: 'El Dancehall es un estilo originario de Jamaica con mucha energía, pasos característicos y una cultura propia. Combina movimientos enérgicos y sensuales con ritmos de reggae y hip-hop, con gran margen para la improvisación y la creatividad. Es ideal si buscas algo más que pasos coreografiados.',
  ...
  dhV3FinalCTADesc: 'Reserva tu plaza ahora y no dejes que te lo cuenten… ni que te lo bailen.',
  dhV3FinalCTAFunny: 'Las plazas vuelan más rápido que un "Dutty Wine" en viernes por la noche.',
  ...
  urbanWhyPrestigeContent:
    'Escuela acreditada por CID-UNESCO con profesores que han actuado en Got Talent España, videoclips internacionales y galas de alto nivel. Formación urbana con prestigio y credibilidad internacional.',

  urbanWhyFacilitiesTitle: 'Instalaciones Profesionales',
  urbanWhyFacilitiesContent:
    'Salas amplias de 700 m² con suelo profesional amortiguado (ideal para movimientos de impacto), espejos de pared completa, sistema de sonido de alta calidad, aire acondicionado y ventilación centralizada. El espacio perfecto para entrenar urbano.',

  // FAQ - Danzas Urbanas Barcelona
  danzasUrbanas_faq_title: 'Preguntas frecuentes sobre nuestras clases de danzas urbanas en Barcelona',
  ...
  urbanFaqA4:
    'Ropa cómoda deportiva (joggers, camiseta holgada o crop top) y zapatillas de street dance o sneakers con buena amortiguación. Para Heels: tacones de 8-12 cm con plataforma y suela de goma. Para Twerk: ropa ajustada (shorts o mallas). Te asesoramos en tu primera clase.',
