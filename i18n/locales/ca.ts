export const ca = {
  ...
  dhV3WhyChoose2Desc: 'Expertes en Dancehall Female, Twerk i cultura afrocaribenyа.',
  dhV3WhyChoose3Title: 'Ubicació immillorable',
  dhV3WhyChoose3Desc: 'Carrer Entença 100, entre Plaça Espanya i Sants.',
  dhV3WhyChoose4Title: 'Ambient familiar i inclusiu',
  dhV3WhyChoose4Desc: 'Sense judicis ni comparacions. Només actitud i bona vibra.',
  dhV3WhyChoose5Title: 'Instal·lacions preparades',
  dhV3WhyChoose5Desc: 'Espais amplis, còmodes i totalment equipats.',
  dhV3WhyChoose6Title: 'Acadèmia multidisciplinària',
  dhV3WhyChoose6Desc: 'Més de 25 estils de ball diferents. L\'avorriment no és opció.',
  dhV3WhyChoose7Title: 'Gala anual i workshops',
  dhV3WhyChoose7Desc: 'Brilla al Teatro Victòria i participa en esdeveniments durant tot l\'any.',
