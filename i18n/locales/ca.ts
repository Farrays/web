export const ca = {
  ...
  philosophyBody1:
    "Cap esforç et reportarà més beneficis que el d'aprendre i practicar un ball. Les endorfines que produeixes ballant generen un augment immediat de la serotonina, i amb això, del teu nivell de benestar. Quan balles, somrius més, t'agrades més, ets més sociable, més flexible i més comprensiu. Si hi ha una cosa capaç de canviar la teva vida des del primer instant, aquesta és, sens dubte, el ball.",
  philosophyBody2:
    "Més que una escola de ball convencional, el que Yunaisy Farray i el seu equip t'ofereixen és un centre reflex dels seus ideals artístics i de la seva manera de viure. Les activitats de Farray’s International Dance Center es distingeixen per seguir un mètode exclusiu i únic creat per Yunaisy Farray, que assegura resultats ràpids, sòlids i contrastats.",
  philosophyQuote: "L'art més noble és el de fer feliços els altres.",
  philosophyQuoteAuthor: 'Phineas Taylor Barnum',
  // Happiness Story
  happinessStoryLine1: 'Hi ha qui busca una escola de ball semblant a les que ja coneix, i no hi ha res de dolent en això.',
  happinessStoryLine2: 'I hi ha qui busca l\'escola que sempre va somiar.',
  happinessStoryLine3: 'A Farray\'s, som d\'aquest segon grup.',
  happinessStoryLine4Part1: 'Però com aquesta escola encara no existia a Barcelona,',
  ...
  happinessStoryPara3Part7: '—ballarina, mestra internacional i ànima d\'aquesta casa—on cada alumne importa, cada història compta i cada moment t\'acosta a la millor versió de tu mateix.',
  happinessStoryPara4: 'Un lloc que no vam copiar d\'enlloc. Un lloc que no existia… fins que el vam construir.',
  // About
  ...
  aboutMethodPillar1Desc:
    'Fonaments tècnics de precisió inspirats en la disciplina clàssica. Estructura, control i poder en cada moviment.',
  aboutMethodPillar2Title: 'Sabor i Ritme',
  aboutMethodPillar2Desc:
    "L'herència i l'ànima dels ritmes afrodescendents. Fluïdesa, expressió i una connexió musical profunda.",
  aboutMethodPillar3Title: 'Innovació Global',
  aboutMethodPillar3Desc:
    "Una metodologia en constant evolució que fusiona estils i trenca barreres, preparant-te per a l'escenari global.",
  ...
  classesIntro:
    "Descobreix les nostres classes de ball per a adults i troba l'estil perfecte per a tu. Qualitat, professionalitat i comunitat al cor de Barcelona, en una acadèmia acreditada per CID-UNESCO.",
  classesCTA: 'Veure Classes de Ball a Barcelona',
  classCatLatinTitle: 'Classes de Salsa i Bachata',
  classCatLatinDesc:
    "Aprèn a ballar salsa i bachata molt a prop de la Plaça Espanya i l'estació de Sants.",
  ...
  classCatMorningDesc:
    'Comença el dia amb energia. Consulta el nostre horari de classes de ball i fitness al matí.',
  ...
  whyPillar4Content:
    "Uneix-te a una família internacional. Gaudeix d'activitats d'oci i pràctiques regulars per socialitzar i perfeccionar el que has après.",
  ...
  servicePrivateDesc:
    "Formació personalitzada al teu ritme i nivell, de forma individual o en grup, a l'acadèmia o a domicili.",
  servicePrivateCTA: 'Sol·licita una Classe',
  serviceAgencyTitle: 'Agència i Productora',
  serviceAgencyDesc:
    'Contracta ballarins i coreògrafs professionals per a esdeveniments, videoclips o espectacles.',
  ...
  teacher1Bio:
    "Icona mundial, creadora del revolucionari 'Mètode Farray®'. El seu estil únic fusiona el foc cubà amb una tècnica rigorosa, formant artistes de talla mundial.",
  teacher2Specialty: 'Especialista en Dansa Urbana i Hip Hop',
  teacher2Bio:
    "En Joni porta l'energia crua del carrer a l'estudi, conegut per les seves coreografies innovadores i el seu estil d'ensenyament empoderador.",
  ...
  danceClassesPageSubtitle:
    "Explora les nostres disciplines d'elit. Cada classe és un portal cap a la mestria, impulsat pel revolucionari 'Mètode Farray®'. Troba el teu ritme, allibera el teu poder.",
  ...
  classDetailContemporaryDesc:
    "Domina l'art de l'expressió a través del moviment fluid i la profunditat emocional. El nostre programa de contemporani fusiona la tècnica clàssica amb la innovació moderna, creant ballarins potents i versàtils.",
  ...
  classDetailUrbanDesc:
    "Domina la pista amb energia crua i coreografies d'avantguarda. Des dels fonaments del Hip Hop fins a les últimes tendències comercials, les nostres classes urbanes construeixen estil, confiança i actitud.",
  ...
  classDetailLatinDesc:
    "Encén la teva passió amb els ritmes electritzants del ball llatí. Dirigides per experts de talla mundial, les nostres classes se centren en la connexió autèntica, el treball de peus intricat i un 'sabor' contagiós.",
  ...
  classDetailFitnessDesc:
    'Esculpeix el físic definitiu del ballarí. Els nostres programes de fitness especialitzats estan dissenyats per potenciar la força, la flexibilitat i la resistència, donant-te el poder per superar els teus límits.',
  classDetailFitnessSubstyles:
    'Acrobàcies, Flexibilitat, Condicionament Corporal, Pilates per a Ballarins',
  classDetailFitnessLevel: 'Tots els Nivells',
  classDetailMorningDesc:
    'Conquereix el dia amb una sessió matutina energitzant. Aquestes classes estan dissenyades per despertar el teu cos, aguditzar la teva ment i establir un to poderós per a les hores futures.',
  classDetailMorningSubstyles:
    'Ioga Matutí, Condicionament, Passos Lliures de Salsa, Passos Lliures de Bachata',
  classDetailMorningLevel: 'Tots els Nivells',
  classDetailWorldDesc:
    "Embarca't en un viatge de dansa global. Explora diverses expressions culturals i disciplines úniques que expandeixen els teus horitzons artístics i desafien el teu cos de noves maneres.",
  ...
  dancehallPillar1Desc:
    "Aprèn els passos fonamentals i el context cultural de la mà d'instructors apassionats per l'herència jamaicana.",
  dancehallPillar2Title: 'Entrenament Total',
  dancehallPillar2Desc:
    "Desenvolupa resistència, coordinació i força amb coreografies d'alta energia que treballen cada múscul.",
  dancehallPillar3Title: 'Allibera la Teva Confiança',
  dancehallPillar3Desc:
    "Adopta l'actitud i l'autoexpressió que són el nucli del Dancehall. Troba el teu poder a la pista de ball.",
  dancehallClassesTitle: 'Els Nostres Programes de Dancehall',
  dancehallClassesSubtitle:
    'Des de principiants absoluts fins a ballarins experimentats, tenim una classe que et desafiarà i inspirarà.',
  dancehallLevelBeginnerTitle: 'Dancehall Fonaments (Nivell 1)',
  dancehallLevelBeginnerDesc:
    "Nou al Dancehall? Comença aquí. Desglossem els passos fonamentals, els 'grooves' i el 'riddim' de la música en un ambient divertit i de suport.",
  dancehallLevelInterTitle: 'Dancehall Dinàmic (Nivell 2)',
  dancehallLevelInterDesc:
    'Per a ballarins amb coneixements bàsics. Aquesta classe se centra en coreografies més complexes, musicalitat i el desenvolupament del teu estil personal.',
  dancehallLevelAdvancedTitle: 'Dancehall Pro (Nivell 3)',
  dancehallLevelAdvancedDesc:
    'Una classe intensiva per a ballarins avançats que busquen perfeccionar la seva tècnica, habilitats escèniques i aprofundir en rutines complexes de nivell professional.',
  ...
  dancehallInstructorBio:
    "Amb arrels a Jamaica i anys de formació amb llegendes del dancehall, l'Izzy aporta una autenticitat i un foc inigualables a les seves classes. És coneguda per la seva energia contagiosa i la seva capacitat per fer que tothom se senti com una estrella.",
  dancehallTestimonialsTitle: 'Què Diuen els Nostres Ballarins',
  dancehallTestimonial1Quote:
    "La classe de l'Izzy és el millor de la meva setmana! L'energia és una bogeria i he après molt sobre la cultura, no només sobre els passos. FIDC és el lloc de referència per al Dancehall a Barcelona.",
  ...
  dancehallFaqQ2: "És el dancehall difícil d'aprendre?",
  dancehallFaqA2:
    "No més que qualsevol altre estil de ball. El dancehall pot semblar intimidant al principi pel seu energia i ritme, però el nostre enfocament pedagògic desglossa cada moviment pas a pas. Comencem amb els fonaments (grooves, riddims bàsics) i avancem gradualment. La majoria dels nostres estudiants principiants estan ballant coreografies completes en poques setmanes. El més important és l'actitud i les ganes de divertir-se.",
  dancehallFaqQ3: 'Necessito estar en forma per a les classes de dancehall?',
  dancehallFaqA3:
    "No necessites estar en forma específica per començar. El dancehall és en si mateix un excel·lent entrenament cardiovascular i de resistència, així que aniràs millorant la teva condició física amb cada classe. Treballem a diferents intensitats i sempre pots adaptar els moviments al teu nivell actual. L'important és escoltar el teu cos i progressar al teu ritme.",
  ...
  classesFaqQ2: 'Puc prendre classes de diferents estils alhora?',
  classesFaqA2:
  ...
  classesFaqA3:
    "Si és la teva primera classe, sempre recomanem començar al nivell de fonaments o principiants. No obstant això, si tens experiència prèvia en ball, els nostres instructors poden avaluar-te a la teva primera classe gratuïta i recomanar-te el nivell més apropiat. També pots provar una classe de nivell intermedi si sents que els fonaments són massa bàsics. L'important és que et sentis desafiat però no aclaparat.",
  ...
  classesFaqQ5: 'Oferiu classes privades o només grupals?',
  classesFaqA5:
    "Oferim ambdues opcions. Les classes grupals són excel·lents per aprendre en comunitat, fer amics i beneficiar-te de l'energia del grup. Les classes privades són ideals si busques atenció personalitzada, tens objectius específics (com preparar-te per a una presentació o casament), o prefereixes un horari més flexible. Molts estudiants combinen ambdues: classes grupals regulars complementades amb sessions privades ocasionals per treballar aspectes específics.",
  // Dancehall Images
  dancehallImage1Alt:
    "Classes de Dancehall a Barcelona - Estudiants ballant a Farray's International Dance Center",
  dancehallImage2Alt:
    "Estudiants gaudint de classes de Dancehall a Barcelona - Ambient enèrgic a Farray's Center",
  dancehallImage3Alt:
  ...
  dhV3HeroTitle: 'Classes de Dancehall a Barcelona',
  dhV3HeroSubtitle: 'Pur Dancehall Jamaicà a Farray\'s Center',
  dhV3HeroDesc: 'Molt més que ball, una manera de viure.',
  dhV3HeroLocation: 'Viatja a Jamaica sense sortir de Barcelona | Classes des d\'iniciació fins avançat, entre Plaça Espanya i Sants',
  ...
  dhV3WhatIsP2: 'El Dancehall és molt més que un ball: és una manera de caminar, de parlar i d\'entendre la vida; una declaració de qui ets. És expressió pura, és ritme, actitud i flow. Al Dancehall no has de ser bo, has de ser tu.',
  dhV3WhatIsP3: 'Els ritmes contagiosos del Dancehall es van difondre ràpidament per tot el món, juntament amb un estil de ball atractiu, enèrgic i sensual.',
  dhV3WhatIsP4: 'Barcelona s\'ha convertit en un dels focus de Dancehall més actius d\'Europa, on la cultura i la diversitat es viuen a cada barri.',
  dhV3WhatIsQuestionTitle: 'Et preguntes si és per a tu?',
  dhV3WhatIsQuestionAnswer: 'Sí, ho és.',
  ...
  dhV3Transform1Title: 'Tornes a tenir energia i ganes',
  dhV3Transform1Desc: 'Les classes et treuen de la rutina i et retornen la vida.',
  dhV3Transform2Title: 'Guanyes seguretat sense adonar-te\'n',
  dhV3Transform2Desc: 'Et deixes anar, t\'alliberes i comences a agradar-te més.',
  dhV3Transform3Title: 'Et poses en forma sense avorrir-te',
  dhV3Transform3Desc: 'Cada classe és diferent. Rius, sues i gaudeixes.',
  dhV3Transform4Title: 'Coneixes gent real',
  dhV3Transform4Desc: 'Res forçat: bon rotllo, comunitat i gent com tu.',
  dhV3Transform5Title: 'Viatges a Jamaica sense sortir de Barcelona',
  dhV3Transform5Desc: 'Ritme, energia i essència real a cada classe.',
  dhV3Transform6Title: 'Aprens moviments nous cada setmana',
  dhV3Transform6Desc: 'Més flow, més estil, més tu.',
  ...
  dhV3WhyChooseTitle: 'Per què triar Farray\'s Center?',
  dhV3WhyChooseSubtitle: 'A Barcelona existeixen moltes escoles de Dancehall, però poques amb veritable trajectòria. A Farray\'s International Dance Center portem més de 8 anys ensenyant Dancehall autèntic.',
  dhV3WhyChoose1Title: 'Acadèmia reconeguda pel CID UNESCO',
  dhV3WhyChoose1Desc: 'Dirigida per Yunaisy Farray, actriu de Street Dance 2 i una de les mestres més reconegudes del món.',
  dhV3WhyChoose2Title: 'Professores formades en arrels jamaicanes',
  dhV3WhyChoose2Desc: 'Expertes en Dancehall Female, Twerk i cultura afrocaribenyа. Classes amb flow, tècnica i autenticitat.',
  dhV3WhyChoose3Title: 'Ubicació immillorable',
  dhV3WhyChoose3Desc: 'Carrer Entença 100, entre Plaça Espanya i Sants, a 5 minuts de Plaça Espanya i Sants. Metro, busos i tren a la porta. Fàcil arribar. Fàcil tornar.',
  dhV3WhyChoose4Title: 'Ambient familiar, amb la professionalitat que necessites',
  dhV3WhyChoose4Desc: 'Proper, inclusiu i sense judicis ni comparacions, però amb la professionalitat que necessites per evolucionar de veritat.',
  dhV3WhyChoose5Title: 'Instal·lacions preparades de veritat',
  dhV3WhyChoose5Desc: 'Més de 700 m², sales àmplies, miralls, so professional, aire condicionat i ventilació centralitzada per entrenar a gust tot l\'any.',
  dhV3WhyChoose6Title: 'Acadèmia multidisciplinària',
  dhV3WhyChoose6Desc: 'Més de 25 estils perquè mai t\'avoreixis i puguis créixer al teu ritme: urbans, balls llatins, contemporani, tècnica, estiraments i molt més.',
  dhV3WhyChoose7Title: 'Gala anual + workshops potents',
  dhV3WhyChoose7Desc: 'Brilla en un teatre professional, participa en workshops internacionals i viu experiències que no trobaràs a cap altra escola.',
  ...
  dhV3TeachersClosing: 'A Farray\'s Center cada profe ensenya amb ànima, coneixement i respecte per la cultura.',
  ...
  dhV3VideoTitle: 'Vine a descobrir les nostres classes de Dancehall',
  ...
  dhV3FaqTitle: 'Preguntes freqüents sobre la nostra escola de Dancehall a Barcelona',
  dhV3FaqQ1: 'Com funcionen les nostres classes de Dancehall a Barcelona?',
  dhV3FaqA1: 'A les nostres classes de Dancehall a Barcelona generalment s\'ensenya una seqüència coreografiada, però a la pràctica el Dancehall és una dansa improvisada. Cada sessió dura 1 hora i inclou: Escalfament (preparació del cos amb exercicis específics), Coreografia (seqüències dinàmiques que combinen passos tradicionals i moderns) i Improvisació (treball de creativitat per portar el teu ball a un nivell informal, expressiu i amb personalitat).',
  dhV3FaqQ2: 'Puc començar des de zero si mai he ballat Dancehall?',
  dhV3FaqA2: 'Clar. Els alumnes que mai han ballat abans trien els cursos de nivell principiant i els qui tenen alguna experiència en algun tipus de ball trien el nivell bàsic. Les nostres classes estan dissenyades perquè qualsevol pugui seguir el ritme des del primer dia.',
  dhV3FaqQ3: 'Què passa si no tinc bona coordinació?',
  dhV3FaqA3: 'No et preocupis, la coordinació es desenvolupa amb la pràctica. Els nostres professors et guiaran pas a pas i l\'ambient és molt acollidor. L\'important és ser constant i gaudir del procés.',
  dhV3FaqQ4: 'Què necessito portar per a les classes de Dancehall a Barcelona?',
  dhV3FaqA4: 'Roba còmoda i lleugera que et permeti moure\'t amb llibertat, sabatilles netes d\'ús exclusiu dins de l\'estudi, tovallola i aigua, perquè ballaràs intensament i necessites hidratar-te.',
  dhV3FaqQ5: 'Quins estils de Dancehall ensenyem a la nostra escola de Barcelona?',
  dhV3FaqA5: 'Dancehall Female: Estil tradicional jamaicà amb moviments autèntics. Sensualitat, actitud i flow. Dancehall Twerk: Integra moviments de Twerk/Bootydance. Energia, sensualitat i feminitat.',
  dhV3FaqQ6: 'Quins nivells de Dancehall tenim a la nostra escola de Barcelona?',
  dhV3FaqA6: 'Principiants: Per començar des de zero, aprendre pas a pas i amb bon ambient. Bàsic: Per a qui ja té alguna experiència en Dancehall o altres danses urbanes. Intermedi: Per millorar tècnica, coordinació i musicalitat amb passos més complexos. Avançat: Per portar el teu nivell al màxim i consolidar el teu estil.',
  dhV3FaqQ7: 'Puc unir-me en qualsevol moment de l\'any?',
  dhV3FaqA7: 'Sí. Pots començar quan vulguis. Consulta el nostre calendari per veure les properes classes disponibles. Si tens dubtes sobre el nivell o el grup, escriu-nos i t\'orientem.',
  ...
  dhV3FaqA11: 'Pots recuperar-la fent la mateixa classe un altre dia o seleccionar un altre estil, sempre que respectis el nivell de la classe i gestionis la recuperació des de l\'aplicació de l\'escola.',
  dhV3FaqQ12: 'Organitzeu esdeveniments o tallers especials?',
  dhV3FaqA12: 'Sí. Organitzem tallers, masterclasses i esdeveniments socials durant l\'any. Segueix-nos a les xarxes o consulta el web per estar al dia.',
  dhV3FaqQ13: 'Les classes són només per a dones o també per a homes?',
  dhV3FaqA13: 'Les nostres classes estan obertes a tothom, sense importar el gènere o l\'experiència prèvia. El Dancehall és per a tots.',
  dhV3FaqQ14: 'Què diferencia el Dancehall d\'altres estils de ball urbà?',
  dhV3FaqA14: 'El Dancehall és un estil originari de Jamaica amb molta energia, passos característics i una cultura pròpia. Combina moviments enèrgics i sensuals amb ritmes de reggae i hip-hop, amb gran marge per a la improvisació i la creativitat. És ideal si busques alguna cosa més que passos coreografiats.',
  dhV3FaqQ15: 'On puc trobar classes de Dancehall a prop de Plaça Espanya a Barcelona?',
  dhV3FaqA15: 'Farray\'s Center està ubicat al Carrer Entença 100, 08015 Barcelona, a només 5 minuts de Plaça Espanya i Estació de Sants. Comptem amb professors amb àmplia experiència i un ambient familiar per a tots els nivells.',
  dhV3FaqQ16: 'Què faig si tinc dubtes o necessito més informació?',
  dhV3FaqA16: 'Telèfon: <a href="tel:+34622247085" class="text-primary-accent hover:underline">+34 622 247 085</a> | Email: <a href="mailto:info@farrayscenter.com" class="text-primary-accent hover:underline">info@farrayscenter.com</a> | Web: <a href="https://www.farrayscenter.com/contacto" class="text-primary-accent hover:underline" target="_blank" rel="noopener noreferrer">www.farrayscenter.com/contacto</a> | Adreça: <a href="https://maps.google.com/?q=Calle+Entença+100,+08015+Barcelona" class="text-primary-accent hover:underline" target="_blank" rel="noopener noreferrer">Carrer Entença 100, 08015 Barcelona</a>',

  dhV3FinalCTATitle: 'Uneix-te a la comunitat de Dancehall més activa de Barcelona',
  dhV3FinalCTASubtitle: 'Fes el pas.',
  dhV3FinalCTADesc: 'Reserva la teva plaça ara i no deixis que t\'ho expliquin... ni que t\'ho ballin.',
  dhV3FinalCTAFunny: 'Les places volen més ràpid que un "Dutty Wine" en divendres a la nit.',
  ...
  classesFaqQ7: 'Quins són els horaris de les classes?',
  classesFaqA7:
    'Tenim classes de dilluns a divendres en horaris de matí (10:00-14:00), tarda (18:00-20:00) i nit (20:00-23:00). També oferim classes els dissabtes. Els horaris varien segons l\'estil i nivell. Et recomanem visitar la pàgina específica de cada estil per veure els horaris detallats, o contactar-nos directament per trobar les classes que millor s\'adaptin a la teva disponibilitat.',
  classesFaqQ8: 'Necessito experiència prèvia per començar?',
  classesFaqA8:
    'No, absolutament no necessites experiència prèvia. Tots els nostres estils de ball tenen classes per a principiants absoluts. Els nostres professors estan especialitzats en ensenyar des de zero i crear un ambient acollidor per a nous estudiants. La primera classe és gratuïta perquè puguis provar sense compromís. Molts dels nostres estudiants més avançats van començar sense cap experiència en ball.',
  ...
  danzaBarcelona_styles_description:
    'Des de la tècnica clàssica del Ballet Cubà fins a l\'expressió lliure de la Dansa Contemporània. Troba el teu estil i nivell, des de principiant fins a avançat.',
  ...
  // ==========================================
  // SALSA I BACHATA BARCELONA PAGE
  // ==========================================
  navSalsaBachata: 'Salsa i Bachata',
  salsaBachataBarcelona_title: 'Classes de Salsa i Bachata a Barcelona | Salsa Cubana, Bachata Sensual i més | Farray\'s Center',
  ...
  salsaBachataFaqA2:
    'No, no necessites venir amb parella. En les nostres classes de ball en parella (salsa, bachata, timba) rotem constantment perquè tots tinguin oportunitat de ballar amb diferents companys. Això t\'ajuda a desenvolupar la teva tècnica de connexió i a sentir-te còmode ballant amb qualsevol persona. També oferim classes individuals de Lady Style i Men Style si prefereixes enfocar-te en la teva tècnica personal.',
  ...
  salsaBachataFaqA4:
    'Cap. Tenim classes per a tots els nivells: Principiant (mai has ballat), Bàsic (coneixes els passos bàsics), Intermedi (balles amb fluïdesa i coneixes figures) i Avançat (domines la tècnica i la musicalitat). Si mai has ballat salsa o bachata, comença en les nostres classes de Principiants on t\'ensenyem des de zero: pas bàsic, temps musical, connexió amb la parella i primeres figures.',

  salsaBachataFaqQ5: 'Quant de temps triga en aprendre a ballar salsa o bachata?',
  salsaBachataFaqA5:
  ...
  salsaBachataFaqA7:
    'Les nostres classes regulars fan servir música gravada dels millors artistes de salsa i bachata (Celia Cruz, El Gran Combo, Marc Anthony, Romeo Santos, Prince Royce, etc.). No obstant això, organitzem esdeveniments especials, festes llatines i workshops amb músics en viu on pots practicar el que has après en un ambient festiu i autèntic. A més, col·laborem amb festivals de salsa a Barcelona.',

  salsaBachataFaqQ8: 'Oferiu classes de Roda de Casino?',
  salsaBachataFaqA8:
    'Sí, la Roda de Casino és part integral de les nostres classes de Salsa Cubana. La roda és una modalitat on múltiples parelles ballen en cercle i un "cantant" (líder) anuncia les figures que tots executen al mateix temps. És molt divertida, social i tradicional a Cuba. Per ballar en roda necessites dominar primer els passos bàsics de salsa cubana i les figures principals.',

  salsaBachataFaqQ9: 'On està ubicada l\'escola de salsa i bachata?',
  salsaBachataFaqA9:
    'Estem al Carrer Entença 100, 08015 Barcelona, a només 5 minuts caminant de Plaça Espanya i l\'Estació de Sants. Metro: L1 (Hostafrancs) / L3 (Tarragona, Plaça Espanya). Tren: Sants Estació. Autobusos: 13, 37, 65, 79, 109, 165. Tenim sales àmplies, climatitzades i amb terra especial per a ball.',
